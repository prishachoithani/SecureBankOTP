...
/**
 * Single Data Access Object for the two related audit tables:
 * transactions and fraud_alerts. Kept together (rather than one DAO per
 * table) since both are written by the same audit pipeline and are
 * small enough that splitting them added a file without adding clarity.
 */
